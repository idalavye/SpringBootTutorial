...
public class PetClinicNewOwnerController {
    ...
    public String handleFormSubmit(@ModelAttribute @Valid Owner owner, BindingResult bindingResult, RedirectAttributes redirectAttributes){
        ...
        //Validation hatalari ile birlikte geri döndür
        if(bindingResult.hasErrors()){
            return "newOwner";
        }
        //Flash attribute 'u bir sonraki web requestine ilgili model attribute 'unu taşıyor. Diğer web requestlerinde artık bu model değeri mevcut olmuyor
        petClinicService.createOwner(owner);
        redirectAttributes.addFlashAttribute("message","Owner create by id : " + owner.getId());
