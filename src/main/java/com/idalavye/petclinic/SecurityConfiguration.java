...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    /**
     * Remember Me;
     * Cookiden username alacak. Bu username'den user bilgilerini elde edecek
     * @prePostEnabled = preAuthorize anotasyonu için
     * @securedEnabled = secured anotasyonu için
     * @jsr250Enabled = rolesAllowed anotasyonunu devreye alıyor
     */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        //http://localhost:8080/petclinic/pet/petclinic.css ulaşmak için;
